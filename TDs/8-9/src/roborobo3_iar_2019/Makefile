MODULES = TemplateRandomwalk TemplateBoids TemplateMedea TemplateWander TemplateEE TemplateVanillaEE TMEevolution TMEboids TMEaggregation TMEdispersion TMEbraitenberg Tutorial
# ### ### ### ### ### ### ###
...
SRC_C	     = $(wildcard src/core/*.c src/contrib/*.c src/contrib/*/*/*.c src/contrib/**/*.c src/ext/*.c)
SRC_CC	     = $(wildcard src/core/*.cpp src/contrib/*.cpp src/contrib/*/*/*.cpp src/contrib/**/*.cpp src/ext/*.cpp)
